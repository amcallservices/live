...
export async function POST(request) {
  try {
    ...
    // Insert annuncio with stato 'in_attesa' (waiting for payment)
    const result = await sql`
      INSERT INTO annunci (
        ...
        ${nome_famiglia}, ${telefono}, ${localita}, ${tipologia},
        ${patologie}, ${orario}, ${compenso}, ${descrizione}, 'in_attesa'
      )
      RETURNING id
    `
    ...
    if (stripeKey) {
      ...
      const response = await fetch('https://api.stripe.com/v1/checkout/sessions', {
        ...
        body: new URLSearchParams({
          ...
          'line_items[0][price_data][product_data][description]': 'Annuncio di ricerca badante per 30 giorni',
